...
export const useChatStore = create((set, get) => ({
  ...
  getAllContacts: async () => {
    ...
    try {
      const resUsers = await axios.get("https://msg-app-frontend-ten.vercel.app/api/msg/all-people", {
  ...
  getAllChats: async () => {
    set({ isUserLoading: true });
    try {
      const resUsers = await axios.get("https://msg-app-frontend-ten.vercel.app/api/msg/chats", {
        withCredentials: true,
      });
  ...
  getMessages: async (id) => {
    ...
    try {
      const resMes = await axios.get(`https://msg-app-frontend-ten.vercel.app/api/msg/${id}`, { withCredentials: true });
    ...
    try {
      ...
      const res = await axios.post(
        `https://msg-app-frontend-ten.vercel.app/api/msg/send/${id}`,
        payload,
        { withCredentials: true }
      );

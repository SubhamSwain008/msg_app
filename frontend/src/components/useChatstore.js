...
set({isUserLoading:true});
    try{
      const resUsers = await axios.get("https://msg-app-subhamswain008s-projects.vercel.app/api/msg/all-people", {
...
set({isUserLoading:true});
    try{
     const resUsers = await axios.get("https://msg-app-subhamswain008s-projects.vercel.app/api/msg/chats", {
            withCredentials: true,
    });
...
getMessages:async(id)=>{
    ...
    try{
     const resMes=await axios.get(`https://msg-app-subhamswain008s-projects.vercel.app/api/msg/${id}`,{withCredentials:true});
  ...
  try {
    ...
    const res = await axios.post(
      `https://msg-app-subhamswain008s-projects.vercel.app/api/msg/send/${id}`,
      payload,
      { withCredentials: true }
    );
